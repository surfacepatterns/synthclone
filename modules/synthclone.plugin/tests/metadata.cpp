...
namespace {
    ...
    void
    verify_simple_component_metadata(
        const synthclone::component_metadata_init_args& args,
    ...
    void
    verify_simple_plugin_metadata(
        const synthclone::plugin_metadata_init_args& args,
        const synthclone::metadata_element& identifier,
        const std::optional<synthclone::metadata_element>& title,
        const std::vector<synthclone::metadata_element>& creators,
        const std::vector<synthclone::metadata_element>& contributors,
...
BOOST_AUTO_TEST_CASE(simple_component_metadata)
{
    verify_simple_component_metadata(
    ...
    verify_simple_component_metadata(
        ...
        "some.other.identifier", "title", {"me", "myself", "I"},
        {"him", "her", "them"}, "description", {"component", "category"});
}

BOOST_AUTO_TEST_CASE(simple_plugin_metadata)
{
    verify_simple_plugin_metadata(
